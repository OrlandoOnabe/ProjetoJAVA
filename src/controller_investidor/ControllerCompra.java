        ...
        try{
            ...
            if(res.next()){
                ...
                if(moedas.getTipo().equals("Ripple")){
                    ...
                    double taxa = res.getDouble("Taxacompra");
                    Ripple ripple1 = new Ripple(saldo_ripple, saldo_real, cotacao, null, taxa, 0);
                    ripple1.compra(valorcompra, taxa);
                    ...
                    double valorcompra = Double.parseDouble(view.getTxtValor().getText());
                    double taxa = res.getDouble("Taxacompra");
                    Bitcoin bitcoin1 = new Bitcoin(saldo_bitcoin, saldo_real, cotacao, null, taxa, 0);
                    bitcoin1.compra(valorcompra, taxa);
                    ...
                    double valorcompra = Double.parseDouble(view.getTxtValor().getText());
                    double taxa = res.getDouble("Taxacompra");
                    Ethereum ethereum1 = new Ethereum(saldo_ethereum, saldo_real, cotacao, null, taxa, 0);
                    ethereum1.compra(valorcompra, taxa);
