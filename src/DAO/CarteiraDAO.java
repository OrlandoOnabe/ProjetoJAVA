...
public class CarteiraDAO {
    ...
    public ResultSet consultarsenha(Investidor carteira) throws SQLException{
    ...
    public ResultSet consultarcpf(Investidor carteira) throws SQLException{
        String sql = "select * from carteira where \"Cpf\" = ?";
        PreparedStatement statement = conn.prepareStatement(sql);
        statement.setString(1, carteira.getCPF());
        statement.execute();
        ResultSet resultado = statement.getResultSet();
        return resultado; 
    }
